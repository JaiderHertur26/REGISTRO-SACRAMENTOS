...
import { 
    Church, Save, ArrowLeft, Loader2, User, 
    Calendar, MapPin, FileText, CheckCircle2, Sliders 
} from 'lucide-react';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.success) {
                ...
                toast({ title: "Bautismo Registrado", description: "El acta permanente ha sido guardada en los libros oficiales.", className: "bg-green-50 text-green-900 border-green-200" });
        ...
        <DashboardLayout entityName={nombreParroquia}>
            <div className="max-w-5xl mx-auto space-y-8 pb-20">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-10 rounded-[2.5rem] border shadow-xl space-y-8">
                    ...
                    {/* SECCIÓN 6: MINISTRO Y PADRINOS */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Input label="Padrinos" name="padrinos" value={formData.padrinos} onChange={handleChange} />
                        <Input label="Ministro (Sacerdote que celebró)" name="ministro" value={formData.ministro} onChange={handleChange} />
                    </div>
