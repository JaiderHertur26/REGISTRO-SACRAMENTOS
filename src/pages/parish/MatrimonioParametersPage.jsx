...
const DEFAULT_PARAMS = {
    ...
    ordinarioFolio: 1,
    ordinarioNumero: 1,
    numeroRegistroActual: '', // 🚀 CAMBIO CLAVE INCLUIDO
...
const MatrimonioParametersPage = () => {
    ...
    useEffect(() => {
        const loadParameters = async () => {
            ...
            console.log("🔍 Cargando parámetros de matrimonios desde Supabase...");
            ...
            try {
                ...
                if (data && data.matrimonios_params) {
                    setParams(prev => ({ ...prev, ...data.matrimonios_params }));
                    console.log("✅ Parámetros cargados:", data.matrimonios_params);
                } else {
    ...
    const handleSaveParameters = async () => {
        ...
        try {
            const payload = {
                ...
                matrimonios_params: params // Guardamos el objeto en la columna de matrimonios
            };
            ...
            toast({
                title: "Sincronizado",
                description: "La configuración de Matrimonios ha sido actualizada en la nube.",
            ...
            <DashboardLayout entityName={user?.parishName || "Parroquia"}>
                <div className="flex items-center justify-center min-h-[400px]">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-gray-500">Descargando configuración de Matrimonios...</p>
                    </div>
                </div>
            </DashboardLayout>
        );
