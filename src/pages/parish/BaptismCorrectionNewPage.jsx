...
const BaptismCorrectionNewPage = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (existingDecree) {
                setIsLoading(false);
                toast({ title: "Decreto Duplicado", description: `El decreto ${decreeData.numeroDecreto} ya existe.`, variant: "destructive" }); return;
            }
            ...
            // 3. Marcar original como anulada
            ...
            // 4. INCREMENTAR CONSECUTIVOS USANDO EL MOTOR MATEMÁTICO CANÓNICO 🚀
            const p = cloudParams || {};
