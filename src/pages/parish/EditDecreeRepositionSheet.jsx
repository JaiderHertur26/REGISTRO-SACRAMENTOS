...
import { Save, X, Loader2, Search, Trash2, FileText, UserPlus, ArrowLeft, History, AlertCircle } from 'lucide-react';
...
const EditDecreeRepositionSheet = () => {
    ...
    const [decreeData, setDecreeData] = useState({
        parroquia: '', numeroDeDecreto: '', fechaEmision: '', conceptoAnulacion: '' 
    });
                        ...
                        <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-6 overflow-hidden min-h-0">
                            ...
                            <div className="lg:col-span-3 h-full overflow-y-auto custom-scrollbar px-2">
                                {!selectedDecreeId ? (
                                    ...
                                    <form onSubmit={handleUpdate} className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500 pb-10">
                                        ...
                                        <div className="fixed bottom-8 right-8 z-50 flex gap-4">
                                            ...
                                            <Button type="submit" disabled={isLoading} className="bg-gradient-to-r from-green-600 to-green-700 hover:shadow-2xl text-white px-10 py-8 rounded-full font-black uppercase tracking-widest text-[10px] shadow-xl active:scale-95 transition-all">
