...
import { 
    ...
    Calendar, User, Fingerprint, PenTool, Droplet, Search, Hash
} from 'lucide-react';
...
const ConfirmationEditPage = () => {
    ...
    const handleChange = (e) => {
        ...
        const uppercaseFields = [
            ...
            'ministro', 'daFe', 'direccion', 'codigoBautizo'
        ];
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            const { error } = await supabase.from('confirmations').update({
                ...
                raw_data: payloadToSave, // Aquí se empaca todo: EDAD, RESPONSABLE, DIRECCIÓN, etc.
                    ...
                    <div className="p-12 space-y-10">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-6">
                                <div><label className={labelClass}>Ministro</label><input name="ministro" required value={formData.ministro || ''} onChange={handleChange} className={`${inputClass} border-l-8 border-l-red-600`} placeholder="EXCMO. MONS..." /></div>
                                <div><label className={labelClass}>Da Fe</label><input name="daFe" required value={formData.daFe || ''} onChange={handleChange} list="lista-parrocos" className={inputClass} /></div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
