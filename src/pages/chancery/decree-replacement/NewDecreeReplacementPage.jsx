                        ...
                        <form onSubmit={handleSubmit} className="bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden relative animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="p-12 space-y-10">
                                ...
                                <section>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                        <div className="md:col-span-3">
                                            ...
                                            <select required name="targetParishId" value={decreeData.targetParishId} onChange={(e) => setDecreeData({...decreeData, targetParishId: e.target.value})} className={`${inputClass} border-amber-200 bg-amber-50/30 text-amber-700`}>
                                ...
                                <div className="flex justify-end gap-4 border-t border-gray-100 pt-12">
                                    ...
                                    <Button type="submit" disabled={isSubmitting || !decreeData.targetParishId} className="bg-gradient-to-r from-[#4B7BA7] to-[#2C3E50] text-white px-12 py-8 rounded-2xl font-black uppercase text-[10px] shadow-xl hover:scale-[1.02] active:scale-95 transition-all">
