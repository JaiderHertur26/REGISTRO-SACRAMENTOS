...
const PrintCorrectionDecreeConfirmations = forwardRef(({ decreeData }, ref) => {
  ...
  confirmationRecord.sexo = (String(confirmationRecord.sexoRaw) === '1' || String(confirmationRecord.sexoRaw).toUpperCase() === 'MASCULINO' || String(confirmationRecord.sexoRaw).toUpperCase() === 'M') ? 'MASCULINO' : 'FEMENINO';
      ...
      <div className="w-full flex-1 flex flex-col">
          ...
          <div className="mb-2 text-[9pt] text-black shrink-0">
            <p className="text-justify leading-snug">
              Por el presente documento, el Gobierno de la Arquidiócesis ordena y autoriza la anulación de la Partida de CONFIRMACIÓN correspondiente a:
            </p>
